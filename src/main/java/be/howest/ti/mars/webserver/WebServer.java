...
public class WebServer extends AbstractVerticle {
    ...
    @Override
    public void stop() {
        H2Repository.getInstance().cleanUp();
    }

    private void configureDatabase(JsonObject dbProps) {
        try {
            H2Repository.configure(dbProps.getString("url"),
    ...
    private void addRoutes(OpenAPI3RouterFactory factory) {
        ...
        addRouteWithCtxFunction(factory, "getOrderByUuid", bridge::getOrderByUuid);
        ...
        addRouteWithCtxFunction(factory, "getFilteredFlights", bridge::getFilteredFlights);
    }
